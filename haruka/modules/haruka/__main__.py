...
def send_start(bot, update):
    ...
    text = "Hey there! My name is Logan I'm Bot - I'm here to help you manage your groups!\n\
Click Help button /help to find out more about how to use me to my full potential.\n\n"

    text += "My Boss is [Here](tg://user?id=OWNER_ID).\n\nWant to add me to your group? [Click here to add me on your group!](t.me/LoganDbot?startgroup=true)"

    keyboard = [[InlineKeyboardButton(text="Support Group", url="https://t.me/Punishersupport")]]
